...
→ **Full step-by-step guide:** [Authoring a module](../modules-system/authoring-modules.md)
covers the canonical package skeleton, every conventional file,
options + tokens + service + module class + barrel + README, plus
the conventions checklist that distinguishes a polished module
from a thrown-together one.
